...
@section('content')
  ...
  <div class="invite_reg">赚钱链接已复制成功，快去发送给好友注册吧！</div>
    ...
    <div class="bg_middle">
       ...
       <div class="freeday_btn">幸运转盘</div>
    </div>
    <div class="bg_bottom">
        <div class="content1">
            <p class="bg_p1" >你获得什么</p>
            <p class="bg_p2" >赚多少</p>
            <p class="bg_bottom_last_p">怎么赚</p>
                <div class="how_to_make_money">
                   <ul><li>1. &nbsp;&nbsp;&nbsp;邀请好友一起玩，你和好友都可以获得免费抢红包和宝马的机会。</li>
                       <li>2. &nbsp;&nbsp;&nbsp;你可以拿好友消费额的一定比例作为佣金返点。（分为两层。你可以拿好友消费额的2%，还可以拿好友邀请的人消费额的1%）。</li>
                       <li>3. &nbsp;&nbsp;&nbsp;你也可以申请为渠道用户，渠道用户佣金高达3.5%以上。<div class="apply_bg"><span>立即申请渠道</span></div></li>
