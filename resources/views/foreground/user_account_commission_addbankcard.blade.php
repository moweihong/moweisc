            ...
            <div class="user-mybanklist">
                ...
                <div class="a_record_bank_add">
                    ...
                    <div class="a_bankcard_list clearfix">
                        <ul>
                            <li class="a_bank_liclick"><span class="a_bankcard_ico a_bankcard_ICBC" title="中国工商银行"></span><i></i></li>
                            <li><span class="a_bankcard_ico a_bankcard_ABC" title="中国农业银行"></span><i></i></li>
                            <li><span class="a_bankcard_ico a_bankcard_CCB" title="中国建设银行"></span><i></i></li>
                            <li><span class="a_bankcard_ico a_bankcard_PSBC" title="中国邮政储蓄银行"></span><i></i></li>
                            <li><span class="a_bankcard_ico a_bankcard_CMB" title="招商银行"></span><i></i></li>
                            <li><span class="a_bankcard_ico a_bankcard_BOC" title="中国银行"></span><i></i></li>
                            <li><span class="a_bankcard_ico a_bankcard_COMM" title="交通银行"></span><i></i></li>
                            <li><span class="a_bankcard_ico a_bankcard_CEB" title="中国光大银行"></span><i></i></li>
                            <li><span class="a_bankcard_ico a_bankcard_CITIC" title="中信银行"></span><i></i></li>
                            <li><span class="a_bankcard_ico a_bankcard_SPABANK" title="平安银行"></span><i></i></li>
                            <li><span class="a_bankcard_ico a_bankcard_CMBC" title="中国民生银行"></span><i></i></li>
                            <li><span class="a_bankcard_ico a_bankcard_CIB" title="兴业银行"></span><i></i></li>
                            <li><span class="a_bankcard_ico a_bankcard_GDB" title="广发银行"></span><i></i></li>
                            <li><span class="a_bankcard_ico a_bankcard_HXBANK" title="华夏银行"></span><i></i></li>
                            <li><span class="a_bankcard_ico a_bankcard_SPDB" title="浦发银行"></span><i></i></li>
                            <li><span class="a_bankcard_ico a_bankcard_BJBANK" title="北京银行"></span><i></i></li>
                        </ul>
                    </div>
                </div>
                <!--addbank end-->
                ...
                <div class="c_address a_address">
                    <div class="c_form_con clearfix" style="margin-bottom:0px;">
                        ...
                        <div class="c_form_right">
                            <input maxlength="10" id="bank_ower_name" onkeyup="value=value.replace(/[^a-zA-Z\u4E00-\u9FA5]/g,'');" class="c_khname" type="text">
                        </div>
                    </div>
                    ...
                    <div class="c_form_con">
                        <label>开户行  ：</label>
                        <div class="c_form_right">
                            <input maxlength="30" id="bank_name" class="c_khname" type="text" value="中国工商银行" readonly="readonly" style="font-size: 16px;">
                        </div>
                    ...
                    <div class="c_form_con">
                        ...
                        <label>卡号：</label>
                        <div class="c_form_right">
                            <input id="card_input" class="c_details_contact a_details_contact" maxlength="19" onkeyup="value=value.replace(/[^0-9]/g,'').replace(/\s/g,'');" type="text">
                    ...
                    <div class="c_form_con">
                        <label>支行 ：</label>
                        <div class="c_form_right">
                            <input maxlength="30" id="bank_subname" class="c_details_contact a_details_contact" type="text" onkeyup="value=value.replace(/[^a-zA-Z\u4E00-\u9FA5]/g,'');">
