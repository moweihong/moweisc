...
<head>
    ...
    <style>
        ...
        .box{width:624px;height:188px;padding:99px 30px 0 184px;background:url("/foreground/img/maintainbg.png") no-repeat 0 0;position:absolute;margin:-144px 0 0 -419px;top:50%;left:50%;font-size:14px;line-height:24px;}
