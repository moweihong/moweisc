...
<script src="{{$url_prefix}}/js/user_security.js"></script>
<script src="{{$url_prefix}}/js/user_history.js"></script>
                ...
                <div class="c_set_save">
                    ...
                    <ul class="c_set_save_box">
                        ...
                        <li class="c_save_tips">完善您的个人资料，可以领取丰厚的奖励哦。</li>
                        	...
                        	@if (empty($userinfo->nickname) || empty($userinfo->sex) )
                        ...
                        <div id="userName2" class="c_rechange_password c_appear " style="">
                            <div class="c_rechange_doing" style="position:relative">
                                    <label>当前昵称：</label>
                                <input id="nickname" type="text" value="{{ $userinfo->nickname }}" maxlength="8">
                                    <label>性别：</label>
                                    ...
                                    <label>生日：</label>
                                <input id="birthday" type="text" value="{{ $userinfo->birthday }}" maxlength="20">
                                	<label>现居地：</label>
                                <input id="now_address" type="text" value="{{ $userinfo->now_address }}" maxlength="20">
                                	<label>家乡：</label>
                                <input id="home_address" type="text" value="{{$userinfo->home_address}}" maxlength="20">
                                	<label>月收入：</label>
                                <input id="salary" type="text" value="{{$userinfo->salary}}" maxlength="8">
                    ...
                    <ul class="c_set_save_box">
                        ...
                        @if (empty($userinfo->qq_openid))
                            <li class="c_save_state">未绑定</li>
                            <li class="c_save_num">--</li>
                            <li class="c_save_rechange"><a href="{{$qq_login_url}}" >绑定</a></li>
                        @else
                            <li class="c_save_state c_save_state_other">已绑定</li>
                            <li class="c_save_num">--</li>
...
<script>
    ...
    var obj = new WxLogin({
        ...
        appid: "{{ config('global.weixin.AppID') }}",
