                ...
                <table id="winTable">
                    <tbody>
                        <tr class="b_part_title">
                            ...
                            <th class="b_th3">幸运码</th>
                            <th class="b_th4">夺宝时间</th>
                            <th class="b_th6">揭晓时间</th>
                        </tr>
                        @foreach ($list as $val)
                            <tr>
                                ...
                                <td class="times0">
                                    {{ date('Y-m-d H:i:s',floor($val->bid_time/1000))}}.{{substr($val->bid_time,-3) }}
                                </td>
                                <td>
                                    {{ date('Y-m-d H:i:s',floor($val->kaijiang_time/1000))}}.{{substr($val->kaijiang_time,-3) }}
                                </td>
                                @endif
                            </tr>
                        @endforeach
