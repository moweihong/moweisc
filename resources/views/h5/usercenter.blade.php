...
@section('content')
   <div>
		<div class="uc_head" style='margin-bottom:0.07rem; '>
			<div class="uc_setting"><img data-url="/user_m/setting" src="{{$h5_prefix}}images/set.png" alt=""></div>
			<div class="uc_headimg"><div class='uch'><img src="{{$url_prefix}}img/def.jpg" alt=""></div></div>
