...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('backend/lib/bootstrap/css/page.css') }}" />
    ...
    <link rel="stylesheet" href="{{ asset('backend/lib/font-awesome/css/font-awesome.css') }}" />
		<link rel="stylesheet" href="{{ asset('backend/lib/time/bootstrap-datetimepicker.min.css') }}" />
    <script src="{{ asset('backend/lib/jquery-1.7.2.min.js') }}" type="text/javascript"></script>
		<script src="{{ asset('backend/lib/time/bootstrap-datetimepicker.min.js') }}" type="text/javascript"></script>
    <script type="text/javascript" src="{{ asset('foreground/js/layer/layer.js') }}"></script>
    <!-- Demo page code -->
  ...
  <!--<![endif]-->
    ...
    <script src="{{ asset('backend/lib/bootstrap/js/bootstrap.js') }}" type="text/javascript"></script>
