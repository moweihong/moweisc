<?php $__env->startSection('my_css'); ?>
    <style>
        ...
        .new_ttmf_bg{width: 100%;height: 1302px;background: url(<?php echo e($url_prefix); ?>img/new_ttmf_bg.jpg) no-repeat center; }
        ...
        .new_ttmf_bg_bottom .new-rotary-tit{width:224px; height: 110px; position: absolute; left:50%; top:-20px; margin-left:-112px; background: url(<?php echo e($h5_prefix); ?>images/dayfree/ykqh2.png) no-repeat}
        .main_content{width: 1200px;margin: 0 auto;position: relative;}
        .new_ttmf_bg .main_content{height: 1302px;}
        .invite_count_bg{width:750px;height:109px;background:url(<?php echo e($url_prefix); ?>img/ttmf_count_bg.png) no-repeat; margin: 0 auto;  padding-top: 20px;padding-left: 30px;}
        ...
        .zhizhen{width:235px;height:270px;background:url(<?php echo e($url_prefix); ?>img/ttmf_clickme.png) no-repeat;;position: absolute;left: 482.5px; bottom: 271px;cursor: pointer;}
        .zhuan_pan{width:700px;height:700px;background:url(<?php echo e($url_prefix); ?>img/ttmf_pan.png) no-repeat;;position: absolute;left: 250px; bottom: 43px;}
        ...
        .new_invite_friend_district{width: 960px;height: 102px;display: block;position: absolute;top:120px;cursor: pointer;background: url(<?php echo e($url_prefix); ?>img/invite_red_bg.png) no-repeat;font-size: 53px;color: white;text-align: center;line-height: 102px;}
        .new_invite_friend_district:hover{color:#fff}
        .invite_finger{width: 144px;height: 129px;display: block;position: absolute;top:2px; left: 480px;background: url(<?php echo e($url_prefix); ?>img/invite_finger.png) no-repeat;z-index: 1;}
        ...
        .hr{width: 1033px;height:1px;margin: 0 auto;background:  url(<?php echo e($url_prefix); ?>img/border_line.png) repeat;}
        ...
        .goods_bg{width: 404px;height: 343px; background: url(<?php echo e($url_prefix); ?>img/ttmf004.png) no-repeat;    text-align: center;  padding-top: 62px;}
        .goods_bg img{width: 258px;}
        .goods_btn{width: 402px;height: 85px; position:absolute; top:350px; left:0px; z-index: 88; background: url(<?php echo e($url_prefix); ?>img/ttmf003.png) no-repeat;  }
        ...
        .award_result{width: 838px;height: 700px;background: url(<?php echo e($url_prefix); ?>img/zhongjiang.png) no-repeat;position: fixed;    z-index: 1;    margin: 0 auto;top: 50%;left: 50%;margin-left: -419px;margin-top: -350px;}
        ...
        .invite_btn a{width:228px;height: 62px;background: url(<?php echo e($url_prefix); ?>img/btn_bg.png) no-repeat;float: right;color:#666666;line-height: 62px;}
        ...
        .other_platform{width: 300px;height: 11px;background: url(<?php echo e($url_prefix); ?>img/other_plateform.png) no-repeat;     margin: 0 auto;  }
		...
		.weixin-login{background: url(<?php echo e($url_prefix); ?>img/other_platform003.png) no-repeat;background-size: 100%;}
		.qq-login{background: url(<?php echo e($url_prefix); ?>img/other_platform001.png) no-repeat;background-size: 100%;}
		.account-login{background: url(<?php echo e($url_prefix); ?>img/prizem-ico-account.png) no-repeat;background-size: 100%;}
		.sina-login{background: url(<?php echo e($url_prefix); ?>img/prizem-ico-sina.png) no-repeat;background-size: 100%;}
		.zone-login{background: url(<?php echo e($url_prefix); ?>img/prizem-ico-qzone.png) no-repeat;background-size: 100%;}
...
<div class="new_ttmf_bg">
	<div class="main_content">
		...
		<!--弹出层 -->
		<!--中奖结果-->	
		<?php /*<div class="award_result alert hide">
		...
		<div class="login_alert alert hide">
           ...
           <div class="other_platform_ioc">
                <a href="<?php echo e($qq_login_url); ?>"><img src="/foreground/img/other_platform001.png"/></a>
                <?php /*<a href="#"><img src="/foreground/img/other_platform002.png"/></a>*/ ?>
              <a href="<?php echo e($wx_login_url); ?>"><img src="/foreground/img/other_platform003.png" /></a>
           </div> 
        </div>
        ...
        <div class="invite_friend_alert alert hide">
           <div class="alert_header"> 
            ...
            <div class="invite_friend_ct">
	            ...
	            <?php /*<div class="share_content_ioc bdsharebuttonbox" data-tag="share_1">*/ ?>
	               <?php /*<a href="#" class="bds_qzone"  data-cmd="qzone"><img src="/foreground/img/other_platform001.png"/></a>*/ ?>
	               <?php /*<a href="#"><img src="/foreground/img/other_platform002.png"/></a>*/ ?>
	               <?php /*<a href="#"><img src="/foreground/img/other_platform003.png" /></a>*/ ?>
	               <?php /*<a href="#"><img src="/foreground/img/other_platform004.png" /></a>*/ ?>
	               <?php /*<a href="#"><img src="/foreground/img/other_platform005.png" /></a>*/ ?>
	            <?php /*</div>*/ ?>
                <div class="share_content_ioc bdsharebuttonbox" data-tag="share_1">
                    ...
                    <?php /*<a class="bds_renren" data-cmd="renren"  style="background: url('/foreground/img/other_platform004.png') no-repeat; height: 50px;display: block"></a>*/ ?>
	...
	<div class="comm-tip-box popdiv" id="login-tip">
		...
		<div class="login-way">
			<div>
				<a href="<?php echo e($wx_login_url); ?>"><i class="weixin-login" style="cursor:hand"></i>微信登录</a>
				<a href="<?php echo e($qq_login_url); ?>"><i class="qq-login" style="cursor:hand"></i>QQ登录</a>
...
<div class="new_ttmf_bg_middle">
    <div class="invite_count_bg">
        <?php if(empty(session('user.id'))): ?>
            <img src="<?php echo e($url_prefix); ?>img/ttmf006.png" />
            <a href="javascript:void(0);" id="not_login">亲，请登录!</a>
        <?php else: ?>
            <img src="<?php echo e($member->user_photo); ?>" />
            <div class="login_after">
                <p>昵称：<?php echo e($member->nickname); ?></p>
                <p>块乐豆：<span class="my_klbean"><?php echo e($member->kl_bean); ?></span>个</p>
                <!--  <p>共获得<i><span  class="total_free_times"><?php echo e($total_free_times); ?></span></i>次免费机会</p>-->
            </div>
        <?php endif; ?>
        <div class="counts_ct">
            <div class="choujiang_count">您剩余<span class="total_last_times"><?php echo e($total_last_times); ?></span> 次抽奖机会 </div>
            <!--<div class="invite_count invite_total">已邀请好友：<span class="invite_total_num"><?php echo e($invite_total); ?></span> /人</div>-->
        </div>
    </div>
	<div class="won_prize_members">
		...
		<div class="won_prize_bg">
            ...
            <?php foreach($anouncement as $key => $item): ?>
                <div class="hr"></div>
                <div class="item_0<?php echo e($key); ?>">
                    <?php foreach($item as $row): ?>
                        <ul><li><?php echo e($row['nickname']); ?></li><li><?php echo e($row['mobile']); ?></li><li><?php echo e($row['prize']); ?></li><li><?php echo e($row['time']); ?></li></ul>
                    <?php endforeach; ?>
                </div>
            <?php endforeach; ?>
			<?php /*<div class="hr"></div>*/ ?>
			<?php /*<div class="item_02">*/ ?>
			<?php /*<ul><li>包尾大师1</li><li>157****9852</li><li>iPhone 6</li><li>2016/06/17  14:12:55</li></ul>*/ ?>
			<?php /*<ul><li>包尾大师2</li><li>157****9852</li><li>iPhone 6</li><li>2016/06/17  14:12:55</li></ul>*/ ?>
			<?php /*<ul><li>包尾大师3</li><li>157****9852</li><li>iPhone 6</li><li>2016/06/17  14:12:55</li></ul>*/ ?>
			<?php /*</div>*/ ?>
			<?php /*<div class="hr"></div>*/ ?>
			<?php /*<div class="item_03">*/ ?>
			<?php /*<ul ><li>包尾大师4</li><li>157****9852</li><li>iPhone 6</li><li>2016/06/17  14:12:55</li></ul>*/ ?>
			<?php /*<ul><li>包尾大师5</li><li>157****9852</li><li>iPhone 6</li><li>2016/06/17  14:12:55</li></ul>*/ ?>
			<?php /*<ul><li>包尾大师6</li><li>157****9852</li><li>iPhone 6</li><li>2016/06/17  14:12:55</li></ul>*/ ?>
			<?php /*</div>*/ ?>
			<?php /*<div class="hr"></div>*/ ?>
			<?php /*<div class="item_04">*/ ?>
			<?php /*<ul><li>包尾大师7</li><li>157****9852</li><li>iPhone 6</li><li>2016/06/17  14:12:55</li></ul>*/ ?>
			<?php /*<ul><li>包尾大师8</li><li>157****9852</li><li>iPhone 6</li><li>2016/06/17  14:12:55</li></ul>*/ ?>
			<?php /*<ul><li>包尾大师9</li><li>157****9852</li><li>iPhone 6</li><li>2016/06/17  14:12:55</li></ul>*/ ?>
			<?php /*</div>*/ ?>
			<div class="hr"></div>
	...
	<?php /*<div class="won_prize_members">*/ ?>
		<?php /*<h1>如何赚取块乐豆？</h1>*/ ?>
		<?php /*<div class="won_prize_bg won_prize_bg2">*/ ?>
			<?php /*<div class="way01">*/ ?>
				<?php /*<h2>块乐豆赚取攻略:</h2>*/ ?>
				<?php /*<p>（1）注册用户在特速一块购平台每消费1块钱，即可获得1块乐豆；</p>*/ ?>
				<?php /*<p>（2）您的受邀好友首次消费即可赠送给您100块乐豆</p>*/ ?>
				<?php /*<p>（3）晒单上传实物照片+分享心得，成功晒单后即可获得100-500块乐豆；</p>*/ ?>
				<?php /*<p>（4）活动期间完善您的个人资料，即可获得30块乐豆，仅首次修改赠送。</p>*/ ?>
			<?php /*</div>*/ ?>
			<?php /*<div class="way02">*/ ?>
				<?php /*<h2>块乐豆使用攻略：</h2>*/ ?>
				<?php /*<p>（1）参与幸运转盘活动，百分百中奖，每次抽奖仅需消耗10块乐豆；另外，推荐一个免费 抽奖的方法，邀请3位好友即可免费抽奖一次哟！</p>*/ ?>
				<?php /*<p>（2）100块乐豆=1块钱，订单支付时可使用块乐豆进行消费，100块乐豆即可获得一个商品块乐码，满满都是幸福感，立即一块购！</p>*/ ?>
				<?php /*<p class="tip_red">（3）温馨提示：块乐豆每年12月31日清零，不花就浪费了，赶紧购起来。</p>*/ ?>
			<?php /*</div>*/ ?>
		<?php /*</div>*/ ?>
	<?php /*</div>*/ ?>
</div>
	...
	<div class="main_content">
		<div class="qiang_ct">
            ...
            <?php foreach($products[0] as $product): ?>
                <div class="goods_bg_ct" data-url="/product/<?php echo e($product->oid); ?>"  style="cursor:hand">
                    <div class="goods_bg"><img src="<?php echo e($product->thumb); ?>" /></div>
                    <div class="goods_desc_ct">
                        <div class="goods_desc">
                            <p> <?php echo e($product->title); ?></p>
                        </div>
                    </div>
                    <div class="goods_btn"  data-url="/product/<?php echo e($product->oid); ?>"  style="cursor:hand">
                        <span><?php echo e($product->title2); ?></span>
                        <a>一块<br/>抢购  </a>
                    </div>
                </div>
            <?php endforeach; ?>
...
<script type="text/javascript" src="<?php echo e($url_prefix); ?>js/jQueryRotate.2.1.js"></script>
<script>
    var _token = $("input[name='_token']").val();
    var flag = <?php echo e($flag); ?>;
    var rotary_request = "<?php echo e($rotary_request); ?>";
    var log = 0;
    var invite_url = "<?php echo e($invite_url); ?>";
