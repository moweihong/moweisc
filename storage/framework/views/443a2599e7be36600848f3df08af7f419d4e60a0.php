...
<div id="member_left" class="member_left">
    <div class="c_left_side">
        <ul class="c_left_nav">
            ...
            <li><a id='menu4' class="c_out_a" href="/user/prize"><i class="c_out_i_three"></i>获得记录  <?php if($myprize > 0): ?><span class="usertips"><?php echo e($myprize); ?></span><?php endif; ?></a></li>
            <li><a id='menu13' class="c_out_a" href="/user/unpay"><i class="c_out_i_two"></i>未支付订单  <?php if($no_pay_count > 0): ?><span class="usertips"><?php echo e($no_pay_count); ?></span><?php endif; ?></a></li>
            <li><a id='menu5' class="c_out_a" href="/user/show"><i class="c_out_i_six"></i>我的晒单 <?php if($myshownum > 0): ?><span class="usertips"><?php echo e($myshownum); ?></span><?php endif; ?></a></li>
