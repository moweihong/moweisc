...
<?php $__env->startSection('title','用户充值'); ?>
        ...
        <div class="prec-t-box clearfix" style="padding-top: 0px">
            ...
            <div class="prec-paylist clearfix">
                <ul>
                    ...
                    <?php /*<li data-payType='unionpay'><b class="paytype-ico paytype-yinlian" ></b><span>银联支付</span><i></i></li>*/ ?>
    ...
    <div id="member_right" class="member_right b_record_box">
        ...
        <div class="b_record_buy">
            ...
            <div class="b_record_list b_record_cloud" style="display: block;">
                ...
                <?php if($list->count()==0): ?>
                    <div style="text-align:center;width:948px;height:530px;padding-top:290px;"><a href="" target="_blank"><img style="width:377px;height:49px;" src="<?php echo e(asset('foreground/img/no_num.png')); ?>" alt="暂无数据"></a></div>
                <?php else: ?>
                        ...
                        <tbody>
                            ...
                            <?php foreach($list as $val): ?>
                                <tr>
                                    ...
                                    <td>
									<?php if($val->status == 1): ?>
									<font color='#52cc14'><?php echo e($val->amount); ?></font> 
									<?php else: ?>
									<font color='#ff0100'><?php echo e($val->amount); ?></font> 
								    <?php endif; ?>
									元
									</td>
                                    <td>
