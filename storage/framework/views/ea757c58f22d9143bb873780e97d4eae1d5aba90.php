...
<?php $__env->startSection('my_uploadjs'); ?>

<script src="<?php echo e(asset('backend/uploadify/jquery.uploadify.mint.js')); ?>" type="text/javascript"></script>

 
 <script type="text/javascript">
  <?php $timestamp = time();?>
  var prizenum = <?php echo e($myprize); ?>; 
...
<div class="b_sup_content">
            ...
            <div class="c_homepage_headercon">
                ...
                <div class="c_headercon_left">
                    ...
                    <a href="javascript:void(0);">
                            <img id="alterFace" src="<?php echo e(session('user.photo')?:config('global.default_photo')); ?>" onerror="javascript:this.src='<?php echo e($url_prefix); ?>img/nodata/tx-loading.png';" />
                    ...
                    <div class="c_investor_details">
                        ...
                        <ul class="c_investor_ul">
                            ...
                            <li>手机：<span id="mobile"></span><?php echo e(session('user.phone')); ?><i>|</i></li>
                            <li>邮箱：<span id="email"></span><?php echo e(session('user.email')); ?><i>|</i></li>
                            <li>昵称：<input id="updateNickName" value="" maxlength="15" style="display: none;"
                                          type="text"/><a href="javascript:void(0)" style="color:#fff;"
                                                          id="nicknamemsg"></a><?php echo e(session('user.nickname')); ?><i>|</i></li>
 ...
 <div class="p-rec-tips" id="myprize" style="text-align:center;">
    ...
    <div class="rec-tiptxt" style="padding-left:0px;">
        <?php if($myprize>0 && isset($my_prize_list)): ?>
        <p style="color: #ff0000;">
            <?php foreach($my_prize_list as $key=>$val): ?>
                <?php if($key<3): ?>
                "<?php echo e(str_limit($val,10,'...')); ?>"
                <?php else: ?>
                等商品
                <?php break; ?>
                <?php endif; ?>
