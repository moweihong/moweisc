<div class="w_details_bottom">
    ...
    <div class="w_calculate_results pgp">
        ...
        <div class="ng-data-inner tabcon-box" style="display: block;">
            <!-- 商品详情 -->
            <?php echo $data['goods']['belongs_to_goods']['content']; ?>
...
<input type="hidden" value="<?php echo e(config('global.base_url').config('global.ajax_path.product_buyrecord')); ?>" id="recordpath"/>
