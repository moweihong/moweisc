<div class="sidebar-nav">
    ...
    <ul id="dashboard-menu" class="nav nav-list collapse">
        <li id='nav-home'><a href="<?php echo e($url_prefix); ?>/home">首页</a></li>
        <li id='nav-admin'><a href="<?php echo e($url_prefix); ?>/admin">管理员列表</a></li>
    ...
    <ul id="accounts-menu" class="nav nav-list collapse ">
        <li id='nav-dht'><a href="<?php echo e($url_prefix); ?>/navigation">导航条管理</a></li>
        <li id='nav-lbt'><a href="<?php echo e($url_prefix); ?>/rotation">轮播图管理</a></li>
    ...
    <ul id="oder-menu" class="nav nav-list collapse">  	
        <li id='nav-order'><a href="<?php echo e(url('/backend/order')); ?>">订单列表</a></li>
        <li id='nav-getprize'><a href="<?php echo e(url('/backend/order/getprize')); ?>">活动订单</a></li> 
        <li id='nav-ordernew'><a href="<?php echo e(url('/backend/order/ordernew')); ?>">抵扣订单</a></li>
    </ul>
    ...
    <ul id="member-menu" class="nav nav-list collapse">
        <li id='nav-user'><a href="<?php echo e(url('/backend/member')); ?>">会员列表</a></li>
        <li id='nav-user'><a href="<?php echo e(url('/backend/member/loginRecord')); ?>">会员登录信息列表</a></li>
        <li id='nav-unsafe'><a href="<?php echo e(url('/backend/member/unsafeuse')); ?>">异常用户管理</a></li>
        <li id='nav-shaidan'><a href="<?php echo e(url('/backend/member/showorder')); ?>">晒单列表</a></li>
        <li id='nav-friendlink' ><a href="<?php echo e(url('/backend/member/friendlink')); ?>">友情链接</a></li>
    </ul>
    ...
    <ul id="error-menu" class="nav nav-list collapse">
        <li id='nav-lottery'><a href="<?php echo e($url_prefix); ?>/lottery">抽奖记录</a></li>
        <li id='nav-rotary'><a href="<?php echo e($url_prefix); ?>/rotary">大转盘奖品配置</a></li>
    </ul>
    ...
    <ul id="shop-menu" class="nav nav-list collapse">
        <li id='nav-shop'><a href="<?php echo e($url_prefix); ?>/shop">商品列表</a></li>
        <li id='nav-shop'><a href="<?php echo e($url_prefix); ?>/shop/merchants">商户列表</a></li>
        <li id='nav-activityList'><a href="<?php echo e($url_prefix); ?>/shop/activityList">活动商品列表</a></li>
        <li id='nav-category'><a href="<?php echo e($url_prefix); ?>/shop/category">商品分类</a></li>
        <li id='nav-addBrand'><a href="<?php echo e($url_prefix); ?>/shop/addBrand">添加品牌</a></li>
    </ul>
    ...
    <ul id="redbao-menu" class="nav nav-list collapse">
        <li id='nav-redbaoList'><a href="<?php echo e($url_prefix); ?>/redbao/getList">红包列表</a></li>
        <li id='nav-redbaoGift'><a href="<?php echo e($url_prefix); ?>/redbao/gift">红包赠送</a></li>
    ...
    <ul id="bank-menu" class="nav nav-list collapse">
        <li id='nav-bank'><a href="<?php echo e($url_prefix); ?>/bank">佣金提现</a></li>
    ...
    <ul id="caiwu-menu" class="nav nav-list collapse">
        <li id='nav-financeChage'><a href="<?php echo e($url_prefix); ?>/finance/chage">充值列表</a></li>
        <li id='nav-financeBuy'><a href="<?php echo e($url_prefix); ?>/finance/buy">消费列表</a></li>
        <li id='nav-financeLottery'><a href="<?php echo e($url_prefix); ?>/finance/lottery">中奖列表</a></li>
        <li id='nav-financeLottery'><a href="<?php echo e($url_prefix); ?>/finance/tongji">数据统计</a></li>
        <li id='nav-financeLottery'><a href="<?php echo e($url_prefix); ?>/finance/redBadBuyShop">抵扣汇总</a></li>
        <li id='nav-financeLottery'><a href="<?php echo e($url_prefix); ?>/finance/bigWheelIfno">幸运转盘红包明细</a></li>
    ...
    <ul id="huafei-menu" class="nav nav-list collapse">
        <li id='nav-financeChage'><a href="<?php echo e($url_prefix); ?>/huafei/recharge">充值列表</a></li>
    </ul>
    ...
    <ul id="promote-menu" class="nav nav-list collapse">
        <li id='nav-promote'><a href="<?php echo e($url_prefix); ?>/promote">充值卡查询</a></li>
        <li id='nav-promote'><a href="<?php echo e($url_prefix); ?>/promote/bangka">新式绑卡法</a></li>
        <li id='nav-userIndex'><a href="<?php echo e($url_prefix); ?>/promote/userIndex">推广人管理</a></li>
        <li id='nav-userIndex'><a href="<?php echo e($url_prefix); ?>/promote/getOfflineInfo">线下体验卡数据查询</a></li>
    </ul>
    ...
    <ul id="message-menu" class="nav nav-list collapse">
        <li id='nav-promote'><a href="<?php echo e($url_prefix); ?>/sys/msg">消息列表</a></li>
        <li id='nav-userIndex'><a href="<?php echo e($url_prefix); ?>/sym/msgedit">发送消息</a></li>
    </ul>
    
	<?PHP IF($admin['id']==1){  ?>
	<a href="#legal-menu" class="nav-header" data-toggle="collapse"><i class="icon-legal"></i>管理员操作</a>
    <ul id="legal-menu" class="nav nav-list collapse">
        <li ><a href="<?php echo e($url_prefix); ?>/manager/creatH5ProHtml?sid=&eid=">批量生成H5商品详情静态HTML</a></li>
    </ul>
	<?PHP } ?>
<!--
