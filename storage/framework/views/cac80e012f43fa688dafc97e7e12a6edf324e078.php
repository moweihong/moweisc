...
<div class="well">
    <form method="post" action="/backend/shop/dealUpShop">
	    ...
	    <tr><td>
	            商品标题：
	            <textarea name="title" style="margin: 0px; width: 639px; height: 103px;" id='shoptitle'><?php echo $shoplist->title; ?></textarea>
	    </td></tr>
	     <tr><td>       	    
    	...
    	<tr><td>
    	供应商名：<input style="width: 360px" size="255" type="text" name='supplier' value="<?php echo e($shoplist->supplier); ?>" ><br />
    	</td></tr>
    	<tr><td>
    	商品总价：<input disabled style="width: 36px" size="6" type="text" name='money' value="<?php echo e($shoplist->money); ?>">&nbsp元<br />
    	</td></tr>
    	...
    	<img src="<?php echo e($shoplist->thumb); ?>" style="border:1px solid #eee; padding:1px; width:50px; height:50px;" id="thumpshow">
           	...
           	<input type="text" id="imagetext" name="thumb" value="<?php echo e($shoplist->thumb); ?>" >
			...
			<fieldset class="uploadpicarr">
                    ...
                    <?php if(!empty($shoplist->picarr)){foreach($shoplist->picarr as $v){?>
                    	<div style="float: left; width: 100px;height: 100px; margin: 20px;">
                    		<img style="width: 100px;height: 100px;" src="<?php echo e($v); ?>" />
                    		<input type="hidden" name=pic[] value="<?php echo e($v); ?>">
                    		<input type="button" value="删除" data-val="<?php echo e($v); ?>" class="delpic">
                    	</div>
                    <?php }}?>
		 ...
		 <tr>
        	<td><h3>商品内容详情：</h3>
				<script name="content" id="myeditor" type="text/plain"><?php echo $shoplist->content; ?></script>
            	<style>
				.content_attr {
