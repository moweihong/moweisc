      ...
      <tbody>
      	<?php foreach($list as $row): ?>
            <tr>
            	...
            	<td><?php echo e($row->total_num); ?></td>
            	<td><?php echo e($row->remain_num); ?></td>
            	<td><?php echo e($row->money); ?></td>
            	<td><?php echo e($row->xiaxian); ?></td>
            	<td><?php echo e(date('Y-m-d h:i:s',$row->start_time)); ?></td>
            	<td><?php echo e(date('Y-m-d h:i:s',$row->end_time)); ?></td>
            	<td>	
              		<a href="javascript:void(0);" role="button" data-toggle="modal" class="upshop" data-id="<?php echo e($row->id); ?>"><i >编辑</i></a>
            		<a href="javascript:void(0);" role="button" data-toggle="modal" class="delshop" data-id="<?php echo e($row->id); ?>"><i >删除</i></a>
            	</td>
            </tr>
        <?php endforeach; ?>
      </tbody>
