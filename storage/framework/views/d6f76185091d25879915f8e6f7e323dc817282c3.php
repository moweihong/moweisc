...
<div class="well">
    <div>
        ...
        <textarea name="phones" style="margin: 0px; width: 1088px; height: 174px;"><?php echo e(session('ordernew.phones')); ?></textarea>
       	<p style="color: red;">多个手机号用英文的逗号","隔开</p>
        <input class="datetimepicker7" id='start_time' style="widht:60px" type="text" name='start_time' value="<?php echo e(session('ordernew.starttime')); ?>" />-
		<input class="datetimepicker7" id='end_time' type="text" name='end_time' value="<?php echo e(session('ordernew.endtime')); ?>"/>
        <input type="submit" value="确认">
        <input id='unset' type="button" value="清空搜索条件">
         <a href="/backend/order/daoBiaonew?<?php echo e($url); ?>"><input type="button" value="导表"></a>
        </form>
    </div>
      	  ...
      	  <?php foreach($orderlist as $row){ ?>
      	       ...
      	       <?php $i=0;foreach($row->dindan as $v){?>
      	  	   <tr>
      	  	   	...
      	  	   	<td><?php echo e(date('Y-m-d H:i:s',$v->bid_time/1000)); ?></td>
      	  	   	<td><?php echo e($v->g_name); ?></td>
      	  	   	<td><?php echo e($v->goods->money); ?></td>
      	  	   	<td><?php echo e($v->g_periods); ?></td>
      	  	   	<td><?php echo e($v->buycount); ?></td>
      	  	   	<td>
      	  	   		<?php if($v->object->is_lottery==2): ?>
	      	  	   		<?php if($v->fetchno>0): ?>
	      	  	   		中奖
	      	  	   		<?php else: ?>
	      	  	   		没中
                    ...
                    ?>
      	  	   	...
      	  	   	<td><?php echo e($row->kld); ?></td>
      	  	   	<td><?php echo e($row->redbao); ?></td>
      	  	   	<td><?php echo e($row->amount-$row->redbao-($row->kld/100)); ?></td>
      	  	   	<?php else: ?>
      	  	   	<td>0</td>
      	  	   	<td>0</td>
      	  	   	<td>0</td>
...
<div id="pageStr" class="pageStr" style="margin: 64px auto;">
   <?php if(is_object($orderlist) && count($orderlist)): ?>
    <?php echo $orderlist->render(); ?>
...
<script>
	...
	{
		$.post('/backend/order/unsetSearchOrdernew',{'_token':"<?php echo e(csrf_token()); ?>"},
		        function(data){  
