...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('/backend/lib/bootstrap/css/bootstrap.css')); ?>">
    
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('/backend/stylesheets/theme.css')); ?>">
...
<!--                     <label class="remember-me"><input type="checkbox" name="remember" value="1"> 记住我</label> -->
    ...
    <script src="<?php echo e(asset('/backend/lib/bootstrap/js/bootstrap.js')); ?>"></script>
