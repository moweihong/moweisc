...
<!--          <th style="width: 15%">类型</th>-->
      ...
      <tbody>
      	...
      	<?php foreach($promotelist as $row): ?>
            <tr>
            	<td><input name="status[]" style="width: 18px" size="6" type="checkbox" value="<?php echo e($row->id); ?>"></td>
            	...
            	<td>
            		<?php if($row->recommend_id): ?>
            		<?php echo e($row->user->mobile); ?>

            		<?php endif; ?>
            	</td>
            	
            	<td>
            		<?php echo e($row->usr_id); ?>

            	</td>
            	<td>
            		<?php if(!empty($row->use_time)): ?>
            		<?php echo e(date('Y-m-d H:i:s',$row->use_time)); ?>
            	...
            	<td>
					<?php if($row->status==3): ?>
            		 <a href="javascript:void(0);" role="button" data-toggle="modal" class="delshop" data-type="0" data-id="<?php echo e($row->id); ?>"><i >解冻</i></a>
            		<?php else: ?>
            		<a href="javascript:void(0);" role="button" data-toggle="modal" class="delshop" data-type="1" data-id="<?php echo e($row->id); ?>"><i >冻结</i></a>
            		<?php endif; ?>
