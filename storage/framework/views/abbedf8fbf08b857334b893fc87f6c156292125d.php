    ...
    <div class="row-fluid">        
        <div class="well">
                ...
                <table cellspacing="1" cellpadding="3" width="100%">
                    <tbody>
                        <tr>
                            <td>文章标题：</td>
                            <td>
                                <input type="text" value="<?php echo e(old('title')); ?>" size="30" maxlength="60" name="title">
            ...
            <div>
                ...
                <script id="editor" type="text/plain" style="width:1024px;height:500px;"><?php echo old('editorValue'); ?></script>
            </div>
