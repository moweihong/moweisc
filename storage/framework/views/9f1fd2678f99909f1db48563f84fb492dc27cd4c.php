...
<?php $__env->startSection('content'); ?>
   <div class="mui-content">
      ...
      <div class="other_platform_ct">
      	...
      	<p onclick='window.location.href="<?php echo e($qq_login_url); ?>"'>
      		<img src="<?php echo e($h5_prefix); ?>/images/qq-tx.png" style="width: 35px;"/>
            <br/>
      		QQ登录
      	</p>
        <?php if($is_weixin): ?>
        <p onclick='window.location.href="<?php echo e($wx_login_url); ?>"'>
      		<img src="<?php echo e($h5_prefix); ?>/images/weichat-tx.png"/>
            <br/>
      		微信登录
      	</p>
        <?php endif; ?>        
<!--      	<p>
      		<img src="<?php echo e($h5_prefix); ?>/images/weibo-tx.png"/>
      		<a href="">微博登录</a>
      	</p>-->
      </div>
